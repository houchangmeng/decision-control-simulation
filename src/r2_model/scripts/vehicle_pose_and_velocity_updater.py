...
class vehicle_pose_and_velocity_updater:
    """
    This Class create a subscriber and three publisher.

    The subscirber is used for receiving gazebo simulator msgs about ego car.
    Four publisher is used for convert gazebo simulator msgs to ego car's velocity and pose.
    """
    ...
    def __init__(self):
        ...
        self.front_pose_pub = rospy.Publisher("/smart/front_pose",PoseStamped,queue_size=1)
    ...
    def model_cb(self,data):
        ...
        rear_x = center_x - cos(yaw) * 0.11607
        rear_y = center_y - sin(yaw) * 0.11607
        ...
        center_x = vehicle_position.position.x
        center_y = vehicle_position.position.y
        front_x = center_x + cos(yaw) * 0.11607
        front_y = center_y + sin(yaw) * 0.11607
        ...
        velocity.twist.linear = vehicle_velocity.linear # km/h
